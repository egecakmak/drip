...
def generate_tfrecord(json_file, images_path, are_augmented):
    tfrecord = json_to_tfrecord.start_conversion(json_file, images_path, are_augmented)
    return tfrecord
...
def main():
    ...
    eval_tfrecord = generate_tfrecord(new_json_file_name_eval, images_path, False)
    train_tfrecord = generate_tfrecord(new_json_file_name_train_augmented, images_path, True)
